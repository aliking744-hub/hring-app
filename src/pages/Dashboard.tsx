...
const sidebarItems = [
  ...
  { icon: Compass, label: "قطب نمای استراتژی", path: "/strategic-compass", external: false },
...
const Dashboard = () => {
  ...
  const handleExportPDF = () => {
    ...
    // FIX: Implement Real PDF Export using jsPDF
    const doc = new jsPDF();
    ...
    yPosition += 10;
    doc.setFontSize(14);
    doc.text("Today's Interviews", 20, yPosition);
    yPosition += 10;
    
    doc.setFontSize(11);
    const interviews = [
      { name: "Sara Ahmadi", position: "UI/UX Designer", time: "10:30" },
      { name: "Mohammad Rezaei", position: "Frontend Developer", time: "14:00" },
      { name: "Zahra Karimi", position: "Product Manager", time: "16:30" },
    ];
    
    interviews.forEach((interview) => {
      doc.text(`${interview.time} - ${interview.name} (${interview.position})`, 25, yPosition);
      yPosition += 8;
    });
