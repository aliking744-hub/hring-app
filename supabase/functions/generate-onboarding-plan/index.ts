...
عنوان شغل: ${jobTitle}
سطح ارشدیت: ${seniorityLabels[seniority] || seniority}
انتظار اصلی: ${expectationLabels[expectation] || expectation}
${mentorRole ? `منتور/همراه: ${mentorRole}` : ""}

نقشه راه را در ۳ ماه طراحی کن با ساختار زیر:
